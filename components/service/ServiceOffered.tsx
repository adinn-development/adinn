...
<div className="px-8 sm:px-16 md:px-18 lg:px-12 py-6 sm:py-8 md:py-12 lg:py-16 ">
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-8 place-items-center">
    {contents.map((content, index) => (
      <div 
        key={index}
        className="bg-white rounded-xl hover:shadow-xl shadow-lg transform hover:-translate-y-1 transition-all duration-300 ease-in-out border border-gray-100 w-full max-w-[740px] h-[250px] flex flex-col items-center justify-center text-center px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-8 md:py-10 lg:py-12"
      >
