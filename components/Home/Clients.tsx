...
const LOGO_CONFIG_BY_SECTION = {
  0: [
    ...
    { id: 2, name: "Havells", image: HavLogo, size: { width: 250, height: 250 } },
    { id: 3, name: "KFC", image: KFCLogo, size: { width: 150, height: 105 } },
    { id: 4, name: "TVS", image: tvsLogo, size: { width: 250, height: 182 } },
    { id: 5, name: "DBS", image: DBSLogo, size: { width: 120, height: 34 } },
    { id: 6, name: "Zomato", image: ZomatoLogo, size: { width: 200, height: 185 } },
    { id: 7, name: "Daikin", image: DaikinLogo, size: { width: 200, height: 200 } },
    { id: 8, name: "Dalmia", image: DalmiaLogo, size: { width: 200, height: 40 } },
    { id: 9, name: "Honda", image: HondaLogo, size: { width: 180, height: 140 } },
    { id: 10, name: "JSW", image: JSWLogo, size: { width: 150, height: 40 } },
    { id: 42, name: "Burger", image: BurgerLogo, size: { width: 100, height: 60 } },
    { id: 46, name: "Royal", image: RoyalLogo, size: { width: 100, height: 40 } },
    { id: 29, name: "IOB", image: IOBLogo, size: { width: 250, height: 240 } },
    { id: 14, name: "Muthhoot", image: MuthhootLogo, size: { width: 250, height: 40 } },
    { id: 15, name: "Nippon", image: NipponLogo, size: { width: 200, height: 140 } },
    { id: 16, name: "TataIpl", image: TataIplLogo, size: { width: 170, height: 140 } },
  ],
  1: [
    { id: 17, name: "Bhima", image: BhimaLogo, size: { width: 200, height: 40 } },
    { id: 18, name: "Asian", image: AsianLogo, size: { width: 300, height: 140 } },
    { id: 19, name: "Ambuja", image: AmbujaLogo, size: { width: 120, height: 80 } },
    ...
    { id: 23, name: "Amrutanjan", image: AmrutanjanLogo, size: { width: 250, height: 140 } },
    { id: 24, name: "Bosch", image: BoschIcon, size: { width: 250, height: 140 } },
    { id: 25, name: "Cas", image: CasLogo, size: { width: 250, height: 40 } },
    { id: 26, name: "Grb", image: GrbLogo, size: { width: 400, height: 190 } },
    { id: 27, name: "Grt", image: GrtLogo, size: { width: 150, height: 40 } },
    { id: 28, name: "Hatsun", image: HatsunLogo, size: { width: 450, height: 240 } },
    { id: 12, name: "LLyod", image: LLyodLogo, size: { width: 200, height: 140 } },
    { id: 30, name: "James", image: JamesLogo, size: { width: 240, height: 180 } },
    { id: 31, name: "Khadim", image: KhadimLogo, size: { width: 200, height: 40 } },
  ],
  2: [
    { id: 32, name: "LG", image: LGLogo, size: { width: 150, height: 40 } },
    { id: 33, name: "Lisha", image: LishaLogo, size: { width: 150, height: 40 } },
    { id: 34, name: "Maruti", image: MarutiLogo, size: { width: 250, height: 240 } },
    { id: 35, name: "Metro", image: MetroLogo, size: { width: 180, height: 40 } },
    { id: 36, name: "Pepe", image: PepeLogo, size: { width: 150, height: 40 } },
    { id: 37, name: "Shriram", image: ShriramLogo, size: { width: 170, height: 140 } },
    { id: 38, name: "SPR", image: SPRLogo, size: { width: 150, height: 40 } },
    { id: 39, name: "Thangamayil", image: ThangamayilLogo, size: { width: 230, height: 140 } },
    ...
    { id: 43, name: "Hero", image: HeroLogo, size: { width: 250, height: 140 } },
    { id: 44, name: "Impex", image: ImpexLogo, size: { width: 250, height: 140 } },
