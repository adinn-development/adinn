    ...
    const ctx = gsap.context(() => {
      ...
      const mainTrigger = ScrollTrigger.create({
        ...
        onUpdate: function(self) {
          ...
          // Calculate new section based on progress
          let newSection = Math.floor(progress * numSections);
          newSection = Math.min(Math.max(newSection, 0), numSections - 1);

          // Update section only if changed
