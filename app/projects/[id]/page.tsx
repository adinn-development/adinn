  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 ">
        {/* Image Section */}
        <div className="text-[#000000] font-medium text-[32px] block sm:hidden md:hidden">
            Project Overview
          </div>
        ...
        <div className="flex-1 flex flex-col space-y-10 px-10">
          <div className="text-[#000000] font-medium text-[32px] hidden sm:block md:block">
            Project Overview
          </div>
          <div className="flex flex-col gap-6 flex-1 justify-between">
            {overViewContents.map((content, index) => (
              <div
                key={index}
                className="bg-[#F6F6FA] rounded-[20px] p-6  shadow-sm"
              >
